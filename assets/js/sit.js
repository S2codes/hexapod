function sitMission() {
  ...
  let missionData = {
    ...
    servo18: 100, // Leg6coxa  | 180 -> back and 0->
...
function standMission() {
  ...
  let missionData = {
    ...
    servo27: 220, //   Leg5Tibia |  0 -> up | 180 -> down

    
    servo18: 140, // Leg6coxa  | 180 -> back and 0->
...
//   console.log("Standing ... ");
//   let missionData = {
//     servo2: 170, // Leg1coxa 180 -> servo go  front | 0 -> servo go  back
//     servo1: 155, //  Leg1Femur 180 ->  servo go up   | 0 ->  servo go down
//     servo0: 180, //  Leg1Tibia 180 ->   servo go down | 0 ->   servo go up
